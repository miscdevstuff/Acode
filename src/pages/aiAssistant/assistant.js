      ...
      if (messageContentElToFinalize && !wasError) {
        ...
        messageContentElToFinalize.querySelectorAll(".code-block").forEach(codeBlock => {
          ...
          expandButton.addEventListener("click", () => {
            ...
            ? `<i class="icon keyboard_arrow_down"></i> <span>Show more</span>`: `<i class="icon keyboard_arrow_up"></i> <span>Show less</span>`;
          });
    ...
    <div className="chat-container">
      ...
      <div className="chat-header">
        <div className="header-left">
          <button className="btn btn-sm btn-outline" id="new-chat-btn" onclick={() => loadOrCreateConversation(null)}>
        ...
        <div className="header-right">
          <button className="btn btn-icon btn-outline" id="settings-btn" title="Settings">
      ...
      <div className="input-area">
        <div className="input-container">
          ...
          <textarea
            ...
            onkeydown={(e) => {
              if (e.key === 'Enter' && !e.shiftKey && sendBtnRef.el && !sendBtnRef.el.disabled) {
                e.preventDefault();
                handleSendBtn();
              }
            }}
